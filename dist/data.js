  ...
  PRODUCT_DESIGNER: {
    ...
    inside: {
      paragraph1: {
        title: "Обязанности:",
        p: [
          "Разработка дизайна и дизайн-системы;",
          "Создание прототипов/вайрфреймов;",
          "Тестирование интерфейсов;",
          "Изучение и внедрение практик UI/UX;",
          "Сотрудничество с PO и BA.",
        ],
      },
      paragraph2: {
        title: "Что ждем от кандидата:",
        p: [
          "2+ года опыта в создании IT продуктов;",
          "Опыт в  разработке дизайн-систем с нуля;",
          "Понимание принципов UI/UX;",
          "Проактивность, инициативность, ответственность;",
  ...
  FRONTEND_LEAD: {
    ...
    inside: {
      paragraph1: {
        title: "Обязанности:",
        p: [
          "Активное участие в проектировании системы;",
          "Разработка новых фронтенд сервисов;",
      ...
      paragraph2: {
        title: "Что ждем от кандидата:",
        p: [
          "3+ года опыта разработки коммерческих веб приложений;",
          "2+ года работы с фреймворком Vue;",
          "Навыки в разработке адаптивных макетов;",
          "Опыт в менеджменте и управлении командой;",
          "Лидерские качества;",
          "Стрессоустойчивость.",
        ],
      },
    ...
    inside: {
      paragraph1: {
        ...
        p: [
          "Активное участие в проектировании системы;",
          "Разработка новых фронтенд сервисов;",
          "Интеграция с существующими фронтенд сервисами;",
          "Оценка проектных задач;",
          "Анализ кода, организация кросс-ревью.",
        ],
      },
      paragraph2: {
        title: "Что ждем от кандидата:",
        p: [
          "3+ года опыта разработки коммерческих веб приложений;",
          "1+ года работы с фреймворком Vue;",
          "Навыки в разработке адаптивных макетов;",
      ...
      paragraph3: {
        title: "Будет плюсом:",
        p: [
          "Опыт участия в старте новых проектов;",
          "Разработка клиентской части под мобильные устройства.",
        ],
      },
    },
  },
    ...
    inside: {
      paragraph1: {
        ...
        p: [
          ...
          "Тестирование API, веб-сервисов;",
          "Разработка документации тестирования;",
          "Заведение и оформление багов.",
        ],
      },
      paragraph2: {
        title: "Что ждем от кандидата:",
        p: [
          "3+ года опыта в тестировании коммерческих приложений;",
          "1+ год в автоматизированном тестировании;",
          "Опыт и организация работы в Postman;",
          "Навыки написания структурированных тестовых сценариев;",
          "Проактивность.",
        ],
      },
      paragraph3: {
        title: "Будет плюсом:",
        p: [
          "Опыт в нагрузочном тестировании;",
          "Опыт в автоматизации UI тестов;",
  ...
  MANUAL_QA: {
    ...
    inside: {
      paragraph1: {
        title: "Обязанности:",
        p: [
          "Тестирование WEB/API приложения;",
          "Разработка документации тестирования;",
          "Заведение и оформление багов;",
      ...
      paragraph2: {
        title: "Что ждем от кандидата:",
        p: [
          "2+ года опыта в тестировании коммерческих приложений;",
          "Опыт работы с тестированием API;",
          "Навыки написания структурированных тестовых сценариев;",
...
dataHide = {
  ...
  // UI2: {
  //   icon: "./img/des-icon.svg",
  //   position: "UI/UX Designer Middle",
  //   experience: "4-6 лет",
  //   officeLocation: "Офис: г. Киев, Украина",
  //   collaborationVariant: "Офис",
  //   buttonData: "UI2",
